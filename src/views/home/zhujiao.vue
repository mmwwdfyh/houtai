<template>
  <div>
    <el-main>
      ...
      >
        ...
        <el-form-item label="审核状态" style="margin-left:20px;">
          <el-select v-model="formInline.region" placeholder="请选择">
            ...
            <el-option label="审核不通过" value="beijing"></el-option>
          </el-select>
        </el-form-item>
      ...
      <el-row>
        <el-button type="primary">新增助教</el-button>
      ...
      <el-table :data="xueList" border style="width: 99%">
        ...
        <el-table-column prop="name" label="助教名称" width="180"></el-table-column>
        <el-table-column prop="shou" label="手机号" width="180"></el-table-column>
        <el-table-column prop="boolean" label="审核状态" width="180"></el-table-column>
